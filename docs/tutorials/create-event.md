...
Este tutorial te guía paso a paso para crear y publicar tu evento en **Desparchado**.
No necesitas conocimientos técnicos previos: solo una cuenta activa en la plataforma.

## 🎯 Objetivo

Al final de este tutorial vas a poder:

- Crear un evento desde el formulario público del sitio.
- Asignarle un lugar, organizadores y presentadores.
- Agregar una imagen y una descripción.
- Publicar o guardar el evento como borrador.

## 🧩 Requisitos previos

- Tener una cuenta de usuarie registrada.
- Haber iniciado sesión.
- Tener la información básica del evento: título, fecha, lugar, descripción e imagen.
...
- Completa todos los campos obligatorios y revisa que la fecha y el lugar estén correctos.
- Adjunta la imagen representativa si la tienes (asegúrate del tamaño y tipo permitidos).
- Presiona **Crear evento** para guardar.
...
- Usa títulos claros, sin mayúsculas innecesarias.
