import EventCardFullWidth from '@presentational_components/components/event-card-full-width/EventCardFullWidth.vue';
import type { Decorator, Meta, StoryObj } from '@storybook/vue3';

// More on how to set up stories at: https://storybook.js.org/docs/writing-stories
const meta = {
  title: 'Components/EventCardFullWidth',
  component: EventCardFullWidth,
  tags: ['autodocs'],
  argTypes: {
    tag: {
      control: 'select',
...
} satisfies Meta<typeof EventCardFullWidth>;
